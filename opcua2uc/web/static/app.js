...
function App() {
  ...
  async function onTestSource(name) {
    try {
      ...
      alert(res.ok ? `OPC UA OK\n${res.server_application_name || ""}` : `OPC UA FAILED\n${res.error || ""}`);
    } catch (e) {
      setError(String(e && e.message ? e.message : e));
    } finally {
      setTestingName(null);
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          null,
          React.createElement("div", { className: "title" }, "Databricks OPC UA Connector"),
          React.createElement("div", { className: "subtitle" }, "Edge configuration & streaming to Zerobus")
        )
      ),
      React.createElement(
        "div",
                  ...
                  return React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        testingName === name ? "Testing…" : "Test OPC UA"
                      ),
                      React.createElement(
                        "button",
                        {
